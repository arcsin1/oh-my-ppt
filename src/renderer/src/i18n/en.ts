...
export const en = {
  ...
  templates: {
    ...
    settingsRequiredDescription: 'Choose local storage and connect your own model API first.',
  ...
  home: {
    ...
    settingsRequired: 'Connect your own model API and choose local storage in Settings first.',
  ...
  settings: {
    ...
    modelSettingsRequiredTitle: 'Personal AI service not connected',
    modelSettingsRequiredDescription:
      'This action uses AI. Choose a service and enter your own API key and model ID; the key is encrypted only on this device.',
...
- Do not create flickering or large-scale shaking animations`
  ...
  sessionDetail: {
    ...
    animationModeToast:
      'Animation mode active — select an element to adjust its animation',
    editorSnap: 'Snap',
    editorGrid: 'Grid',
    ...
    pptxAnimationCompatibilityNotice:
      'Native animations were added where possible. Check the file in your company WPS or PowerPoint; unsupported effects still keep their final static content.',
